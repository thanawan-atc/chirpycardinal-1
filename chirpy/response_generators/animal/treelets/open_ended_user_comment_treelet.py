...
class OpenEndedUserCommentTreelet(Treelet):
    ...
    def get_prompt(self, conditional_state=None):
        ...
        if conditional_state and conditional_state.cur_animal:
            entity = conditional_state.cur_animal
        else:
            entity = state.cur_animal
    ...
    def get_response(self, priority=ResponsePriority.STRONG_CONTINUE, **kwargs):
        ...
        if ResponseType.QUESTION in response_types:
            ...
            prefix = f'yeah, i think {cur_talkable_animal}'
        ...
        if get_factoid(entity) is not None:
            ...
            prompt_treelet = ''
            needs_prompt = True
            concluding_statement = get_concluding_statement(cur_talkable_animal)
