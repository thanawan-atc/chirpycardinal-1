...
from chirpy.response_generators.animal.regex_templates.word_lists import *
...
class FavoriteTypeTemplate(RegexTemplate):
    slots = {
        ...
        'animal': list(ANIMALS.keys())
    }
    templates = [
        "my favorite {animal} is {type}",
        "my favorite is {type}",
        "my favorite {animal} of all time is {type}",
        "my favorite of all time is {type}",
        "my favorite {animal} is probably {type}",
        "my favorite is probably {type}",
        "my favorite {animal} of all time is probably {type}",
        ...
        "i follow {type}",
        "{continuer} my favorite {animal} is {type}",
