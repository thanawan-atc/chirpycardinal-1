...
from chirpy.response_generators.color2.color_helpers import ResponseType
from chirpy.response_generators.color2.state import ConditionalState
...
class IntroductoryTreelet(Treelet):
    ...
    def get_response(self, priority=ResponsePriority.STRONG_CONTINUE):
        ...
        return ResponseGeneratorResult(
            text="By the way, what's your favorite color?",
            ...
            conditional_state=self.rg.ConditionalState(
                ...
                next_treelet_str=self.rg.ask_why_favorite_color_treelet.name
            )
        )
