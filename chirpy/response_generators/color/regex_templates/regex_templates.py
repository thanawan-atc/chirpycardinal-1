...
class FavoriteTypeTemplate(RegexTemplate):
    ...
    templates = [
        "my favorite {color} is {type}",
        "my favorite is {type}",
        "my favorite {color} of all time is {type}",
        "my favorite of all time is {type}",
        "my favorite {color} is probably {type}",
        "my favorite is probably {type}",
        "my favorite {color} of all time is probably {type}",
        ...
        "i follow {type}",
        "{continuer} my favorite {color} is {type}",
